...
cd /root && GIT_SSH_COMMAND="ssh -o StrictHostKeyChecking=no" git clone https://$GITLAB_USERNAME:$GITLAB_TOKEN@gitlab.com/kdg-ti/integratieproject-1/202324/23_codeforge/development.git
